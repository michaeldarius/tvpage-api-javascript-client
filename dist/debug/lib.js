(function () {
var tfw;(function () { if (!tfw || !tfw.requirejs) {
if (!tfw) { tfw = {}; } else { require = tfw; }
...
(function (global) {
  ...
  /**
   * Support tfw.require.config() to make it easier to cooperate with other
...
tfw.requirejs = requirejs;tfw.require = require;tfw.define = define;
}
}());
...
if ( typeof tfw.define === 'function' && tfw.define.amd && tfw.define.amd.jQuery ) {
	tfw.define( "jquery", [], function () { return jQuery; } );
}

})( window );

tfw.define('jquery_noconflict',['jquery'], function($){
...
tfw.define("backbone", ["underscore","jquery"], (function (global) {
    return function () {
        var ret, fn;
...
tfw.define('tvp/data/Collection',[
  "jquery",
  'underscore',
	"backbone",
  "tvp/data/Model"
  ...
  var TVPCollection = Backbone.Collection.extend({
    ...
    constructor: function (models, options) {
      ...
      if (_.isObject(options) && _.has(options,'baseUrl')) {
        ...
        this.baseUrl = "https://www.tvpage.com";
      }
...
tfw.define('tvp/data/SpotCollection',[
	"tvp/data/Collection"
],
...
tfw.define('tvp/data/GuideCollection',[
	"tvp/data/Collection"
],
	function(TVPCollection) {
    ...
    /*        
      ...
      /*
			...
			_.each(response,function(itm,n){
				if(itm.assetDetails){
					itm.assetDetails.prettyDuration = t.prettyDuration(Number(itm.assetDetails.mediaDuration));
...
function(SpotCollection, GuideCollection) {
  ...
  function($, TVPInterface) {
    ...
    TVPage.init = function(){
      if ( !TVPage.__global.hasOwnProperty('options') ){
        throw new Error("Must call TVPage.config with options");
      }
      var options = TVPage.__global.options;
      var callback = TVPage.__global.callback;
